...
<body class="bg-gray-100">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white p-6 rounded-t-lg shadow-sm border-b border-gray-200 mt-10">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Gérez vos enregistrements de clients</p>
                </div>
        ...
        <!-- Search Form -->
        <form action="{{ route('clients.index') }}" method="GET" class="bg-white p-6 border-b border-gray-200">
            <div class="flex">
                <input type="text" 
                       name="search" 
